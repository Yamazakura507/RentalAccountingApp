using RentalAccountingApp.Classes;
    ...
    public partial class SettingsForm : Form
    {
        ...
        private void SettingsFormOnLoad(object sender, EventArgs e)
        {
            if (!File.Exists("connection_list.json"))
            {
                ...
                Connections.Add(new(true, AppInfo.DefaultConnection, true));
        ...
        private void LoadConnectionList()
        {
            ...
            Connections = AppInfo.Conections.ToList();
        ...
        {
            this.InterfaceLock(tspbProgress);
            ...
            if (actionSave != 2 && !connection.ConnectionBuilder.IsCheckConection())
            {
                ...
                switch (result)
                {
                    ...
                    case DialogResult.No:
                        this.InterfaceUnlock(tspbProgress);
                        return;
                }
            }
