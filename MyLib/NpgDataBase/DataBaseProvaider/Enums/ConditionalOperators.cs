...
namespace DataBaseProvaider.Enums
{
    ...
    /// <para>Between - Этот ограничитель используеться для фильтрации выставляя диапазон значения от и до</para>
    /// <para>In - Этот ограничитель используеться для фильтрации выставляя диапазон конкретных значений</para>
    /// <para>NotIn - Этот ограничитель используеться для фильтрации выставляя отрицательный диапазон конкретных значений</para>
    /// </remarks>
    public enum ConditionalOperators
    {
        ...
        /// </summary>
        /// <remarks>
        /// Этот ограничитель используеться для фильтрации выставляя диапазон конкретных значений
        /// </remarks>
        /// <value>12</value>
        [Comment("Ограничитель диапазона")]
        [Description("IN")]
        ...
        /// </summary>
        /// <remarks>
        /// Этот ограничитель используеться для фильтрации выставляя отрицательный диапазон конкретных значений
        /// </remarks>
        /// <value>13</value>
        [Comment("Ограничитель диапазона")]
        [Description("NOT IN")]
